...
class DetailPage extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    _buildPortraitBody(context, pokeballImageUrl) : _buildLandscapeBody(context, pokeballImageUrl);
  }
  Scaffold _buildLandscapeBody(BuildContext context, String pokeballImageUel){
      return Scaffold(
                        ...
                        Expanded(
                          child: Hero(
                            ...
                            child: CachedNetworkImage(imageUrl: pokemon.img ?? '',
                              height: 0.20.sw, fit: BoxFit.fitHeight,
                            ),
                          ),
                        ),
                      ],
        ...
        child: Column(
          ...
          children: [
            ...
            Expanded(
                child:Stack(
                  children: [
                    Positioned(child: Image.asset(pokeballImageUrl, height:0.15.sh ,
                    ...
                    Align(
                      ...
                      child: Hero(
                        tag: pokemon.id!,
                        child: CachedNetworkImage(imageUrl: pokemon.img ?? '',
                          height: 0.25.sh, fit: BoxFit.fitHeight,
                        ),
                      ),
                    )
